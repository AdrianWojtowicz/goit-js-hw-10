...
var fetchCountries = function fetchCountries(name) {
  return fetch("https://restcountries.com/v2/name/".concat(name, "?fields=name,capital,population,flag,languages")).then(function (response) {
    if (!response.ok) {
...
var findCountry = function findCountry() {
  var name = searchBox.value.trim();

  if (name === "") {
    _notiflix.default.Notify.info('Please type in a country name');

    countryList.innerHTML = '';
    countryInfo.innerHTML = '';
  } else {
    (0, _fetchCountries.fetchCountries)(name).then(function (data) {
...
var renderList = function renderList(data) {
  var markup = data.map(function (d) {
    return "<li class=\"list__item\">\n      <img class=\"list__flag\" src=\"".concat(d.flag, "\" alt=\"Flag of ").concat(d.name, "\" width=\"55\" >\n      <p class=\"list__name\">").concat(d.name, "</p>\n      </li>");
  }).join('');
...
var renderInfo = function renderInfo(data) {
  var markup = data.map(function (d) {
    return "<img class=\"info__flag\" src=\"".concat(d.flag, "\" alt=\"Flag of ").concat(d.name, "\" width=\"55\" >\n      <span class=\"info__name\">").concat(d.name, "</span>\n      <p class=\"info__data\"><b>Capital</b>: ").concat(d.capital, "</p>\n      <p class=\"info__data\"><b>Population</b>: ").concat(d.population, "</p>\n      <p class=\"info__data\"><b>Languages</b>: ").concat(d.languages.map(function (language) {
...
searchBox.addEventListener('input', (0, _lodash.debounce)(findCountry, DEBOUNCE_DELAY));
},{"./css/styles.css":"css/styles.css","notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js","./fetchCountries":"fetchCountries.js","lodash":"../node_modules/lodash/lodash.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
